...
k3d cluster create willcluster -p "80:80@loadbalancer" -p "443:443@loadbalancer" || echo "Cluster déjà existant"

echo "=== Vérification du cluster ==="
kubectl get nodes

echo "=== Création des namespaces ==="
kubectl create namespace argocd || echo "Namespace argocd déjà créé"
kubectl create namespace dev || echo "Namespace dev déjà créé"
